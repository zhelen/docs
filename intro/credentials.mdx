...
<Frame>
  <img src="/intro/bearer_token.png" />
</Frame>
...
Some APIs require your User ID, which is a unique integer that identifies you within Petal. You can get your User ID in the responses of certain API requests, but if you still have your developer tool open, you can also get it there.

While the Petal app is open on your browser, you will see in your developer tool that your browser makes occasional requests to `https://cite.petal.org/api/user/<id>`. Simply note this number down. Below is an image depicting what you can expect to see in your window.

<Frame>
  <img src="/intro/user_id.png" />
</Frame>
